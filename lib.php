 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ncm_graded_users_iterator {

    /**
     * The user Id  we are interested in
     */
    protected $userid;
     ...
     * Constructor
     *
     * @param userid $userid The student Id
     ...
     */
    public function __construct($userid, $course, $grade_items=null, $groupid=0,
 ...
 * @return null
 */
function ncmprint_graded_users_selector($course, $actionpage, $userid=0, $groupid=0, $includeall=true, $return=false) {
...
function ncmgrade_get_graded_users_select($report, $course, $userid, $groupid, $includeall) {
    global $USER, $CFG;
    ...
    while ($userdata = $gui->ncm_next_user()) {
        $user = $userdata->user;
 ...
 */
function ncmhide_natural_aggregation_upgrade_notice($courseid) {
 ...
 * @param int $courseid The current course id.
 */
function ncmgrade_hide_min_max_grade_upgrade_notice($courseid) {
 ...
 * @param int $courseid The current course id.
 */
function ncmgrade_upgrade_use_min_max_from_grade_grade($courseid) {
 ...
 * @param int $courseid The current course id.
 */
function ncmgrade_upgrade_use_min_max_from_grade_item($courseid) {
 ...
 * @param int $courseid The current course id.
 */
function ncmhide_aggregatesubcats_upgrade_notice($courseid) {
 ...
 * @param int $courseid The current course id.
 */
function ncmhide_gradebook_calculations_freeze_notice($courseid) {
 ...
 */
function ncmprint_natural_aggregation_upgrade_notice($courseid, $context, $thispage, $return=false) {
    global $CFG, $OUTPUT;
    $html = '';
 ...
 * @return nothing or string if $return true
 */
function ncmprint_grade_plugin_selector($plugin_info, $active_type, $active_plugin, $return=false) {
 ...
 * @return nothing or string if $return true
 */
function ncmgrade_print_tabs($active_type, $active_plugin, $plugin_info, $return=false) {
    global $CFG, $COURSE;
 ...
 * @return array
 */
function ncmgrade_get_plugin_info($courseid, $active_type, $active_plugin) {
    global $CFG, $SITE;
...
class ncm_grade_plugin_info {
     ...
     * @return void
     */
    public function ncm__construct($id, $link, $string, $parent=null) {
        $this->id = $id;
        $this->link = $link;
        $this->string = $string;
        $this->parent = $parent;
 ...
 */
function ncmprint_grade_page_head($courseid, $active_type, $active_plugin=null,
...
class ncm_grade_plugin_return {
     ...
     */
    public function ncm__construct($params = null) {
        if (empty($params)) {
     ...
     */
    public function ncmgrade_plugin_return($params = null) {
     ...
     */
    public function ncmget_options() {
        if (empty($this->type)) {
            return array();
        }
     ...
     * @return string url
     */
    public function ncmget_return_url($default, $extras=null) {
        global $CFG;
     ...
     * @return string
     */
    public function ncmget_form_fields() {
        if (empty($this->type)) {
            return '';
        }
     ...
     * @return void
     */
    public function ncmadd_mform_elements(&$mform) {
        if (empty($this->type)) {
            return;
        }
     ...
     */
    public function ncmadd_url_params(moodle_url $url) {
        if (empty($this->type)) {
            return $url;
        }
...
/**
 * function ncmcentral to gradebook for building and printing the navigation (breadcrumb trail).
 *
 ...
 * @return string
 */
function ncmgrade_build_nav($path, $pagename=null, $id=null) {
...
class ncm_grade_structure {
    ...
    */
     ...
     */
    public function ncmget_element_icon(&$element, $spacerifnone=false) {
        global $CFG, $OUTPUT;
     ...
     */
    public function ncmget_element_header(&$element, $withlink = false, $icon = true, $spacerifnone = false,
    ...
    private function ncmget_activity_link($element) {
        global $CFG;
     ...
     */
    public function ncmget_grade_analysis_url(grade_grade $grade) {
        global $CFG;
        /** @var array static cache of the grade.php file existence flags */
        static $hasgradephp = array();
     ...
     * @return string
     */
    public function ncmget_grade_analysis_icon(grade_grade $grade) {
        global $OUTPUT;
     ...
     * @return string eid
     */
    public function ncmget_grade_eid($grade_grade) {
     ...
     * @return string eid
     */
    public function ncmget_item_eid($grade_item) {
     ...
     * @return array
     */
    public function ncmget_params_for_iconstr($element) {
     ...
     */
    public function ncmget_reset_icon($element, $gpr, $returnactionmenulink = false) {
        global $CFG, $OUTPUT;
     ...
     * @return string|action_menu_link
     */
    public function ncmget_edit_icon($element, $gpr, $returnactionmenulink = false) {
        global $CFG, $OUTPUT;
     ...
     * @return string|action_menu_link
     */
    public function ncmget_hiding_icon($element, $gpr, $returnactionmenulink = false) {
        global $CFG, $OUTPUT;
     ...
     * @return string
     */
    public function ncmget_locking_icon($element, $gpr) {
        global $CFG, $OUTPUT;
     ...
     * @return string|action_menu_link
     */
    public function ncmget_calculation_icon($element, $gpr, $returnactionmenulink = false) {
        global $CFG, $OUTPUT;
        if (!has_capability('moodle/grade:manage', $this->context)) {
            return $returnactionmenulink ? null : '';
        }
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ncm_grade_seq extends grade_structure {
     ...
     */
    public function ncm__construct($courseid, $category_grade_last=false, $nooutcomes=false) {
        global $USER, $CFG;
     ...
     * @deprecated since Moodle 3.1
     */
    public function ncmgrade_seq($courseid, $category_grade_last=false, $nooutcomes=false) {
        debugging('Use of class name as constructor is deprecated', DEBUG_DEVELOPER);
     ...
     * @return array
     */
    public function ncmflatten(&$element, $category_grade_last, $nooutcomes) {
     ...
     */
    public function ncmlocate_element($eid) {
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ncm_grade_tree extends grade_structure {
     ...
     * @param bool  $nooutcomes Whether or not outcomes should be included
     */
    public function ncm__construct($courseid, $fillers=true, $category_grade_last=false,
     ...
     * @deprecated since Moodle 3.1
     */
    public function ncmgrade_tree($courseid, $fillers=true, $category_grade_last=false,
                               $collapsed=null, $nooutcomes=false) {
        debugging('Use of class name as constructor is deprecated', DEBUG_DEVELOPER);
     ...
     * @return void
     */
    public function ncmcategory_collapse(&$element, $collapsed) {
     ...
     * @return void
     */
    public function ncmno_outcomes(&$element) {
        if ($element['type'] != 'category') {
            return;
        }
     ...
     * @return void
     */
    public function ncmcategory_grade_last(&$element) {
        if (empty($element['children'])) {
            return;
        }
     ...
     * @return void
     */
    public function ncmfill_levels(&$levels, &$element, $depth) {
     ...
     */
    public static function ncmcan_output_item($element) {
        $canoutput = true;
     ...
     * @return int
     */
    public function ncminject_fillers(&$element, $depth) {
        $depth++;
     ...
     * @return int
     */
    public function ncminject_colspans(&$element) {
        if (empty($element['children'])) {
            return 1;
        }
        $count = 0;
     ...
     * @return string $xml
     */
    public function ncmexporttoxml($root=null, $tabs="\t") {
        $xml = null;
        $first = false;
        if (is_null($root)) {
     ...
     * @return string
     */
    public function ncmexporttojson($root=null, $tabs="\t") {
        $json = null;
        $first = false;
        if (is_null($root)) {
            $root = $this->top_element;
     ...
     * @return grade_item
     */
    public function ncmget_item($itemid) {
...
/**
 * Local shortcut function ncmfor creating an edit/delete button for a grade_* object.
 * @param string $type 'edit' or 'delete'
 * @param int $courseid The Course ID
 * @param grade_* $object The grade_* object
 * @return string html
 */
function ncmgrade_button($type, $courseid, $object) {
    global $CFG, $OUTPUT;
 ...
 */
function ncmgrade_extend_settings($plugininfo, $courseid) {
    global $PAGE;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class ncm_grade_helper {
    /**
     ...
     * @return array
     */
    public static function ncmget_plugin_strings() {
     ...
     * @return array
     */
    public static function ncmget_aggregation_strings() {
     ...
     */
    public static function ncmget_info_manage_settings($courseid) {
     ...
     * @return array
     */
    public static function ncmget_plugins_reports($courseid) {
        global $SITE;
     ...
     * @return grade_plugin_info
     */
    public static function ncmget_info_scales($courseid) {
     ...
     * @return grade_plugin_info
     */
    public static function ncmget_info_outcomes($courseid) {
        global $CFG, $SITE;
     ...
     * @return array
     */
    public static function ncmget_info_letters($courseid) {
        global $SITE;
     ...
     * @return array
     */
    public static function ncmget_plugins_import($courseid) {
        global $CFG;
     ...
     * @return array
     */
    public static function ncmget_plugins_export($courseid) {
        global $CFG;
     ...
     */
    public static function ncmget_user_field_value($user, $field) {
        if (!empty($field->customid)) {
     ...
     */
    public static function ncmget_user_profile_fields($courseid, $includecustomfields = false) {
        global $CFG, $DB;
     ...
     */
    public static function ncmfetch_all_natural_weights_for_course($courseid) {
        global $DB;
        $result = array();
